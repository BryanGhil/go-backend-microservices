...
const file_pb_payment_proto_rawDesc = "" +
	"\n" +
	"\x10pb/payment.proto\x12\apayment\"4\n" +
	...
	"\x10GetPaymentStatus\x12 .payment.GetPaymentStatusRequest\x1a!.payment.GetPaymentStatusResponseB\x0eZ\fecommerce/pbb\x06proto3"
...
var file_pb_payment_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pb_payment_proto_goTypes = []any{
	(*GetPaymentStatusRequest)(nil),  // 0: payment.GetPaymentStatusRequest
	(*GetPaymentStatusResponse)(nil), // 1: payment.GetPaymentStatusResponse
}
var file_pb_payment_proto_depIdxs = []int32{
	0, // 0: payment.PaymentService.GetPaymentStatus:input_type -> payment.GetPaymentStatusRequest
	1, // 1: payment.PaymentService.GetPaymentStatus:output_type -> payment.GetPaymentStatusResponse
